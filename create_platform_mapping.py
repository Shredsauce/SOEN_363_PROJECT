...
if __name__ == "__main__":
    ...
    rawg_platforms = load_json_data('platforms_data_rawg.json')  # Adjust the path as necessary
    igdb_platforms = load_json_data('platforms_data_igdb.json')  # Adjust the path as necessary

    # Create the platform mapping
    mapping = create_platform_mapping(rawg_platforms, igdb_platforms)

    # Save the mapping to a JSON file
    with open('platform_mapping.json', 'w', encoding='utf-8') as file:
